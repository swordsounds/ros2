...
bool cdr_serialize_more_interfaces__msg__AddressBook(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_more_interfaces
bool cdr_deserialize_more_interfaces__msg__AddressBook(
  eprosima::fastcdr::Cdr & cdr,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_more_interfaces
bool cdr_serialize_key_more_interfaces__msg__AddressBook(
  const more_interfaces__msg__AddressBook * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: first_name
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_more_interfaces
size_t get_serialized_size_key_more_interfaces__msg__AddressBook(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _AddressBook__ros_msg_type * ros_message = static_cast<const _AddressBook__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_more_interfaces
size_t max_serialized_size_key_more_interfaces__msg__AddressBook(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const more_interfaces__msg__AddressBook * ros_message = static_cast<const more_interfaces__msg__AddressBook *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_more_interfaces__msg__AddressBook(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  more_interfaces__msg__AddressBook * ros_message = static_cast<more_interfaces__msg__AddressBook *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_more_interfaces__msg__AddressBook(cdr, ros_message);
}
